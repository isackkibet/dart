...
android {
    ...
    defaultConfig {
        applicationId = "com.main.yohpal_app"
...
// Prevent compilation of the generated registrant which references plugin
// classes that may not be available at compile-time in this workspace.
